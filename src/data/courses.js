...
export const wingCourses = [
  { name: 'Wing Taster', hours: 2, target: 'Try it once — no commitment', pricePrivate: 190, priceGroup: 150 },
  { name: 'Wing Starter', hours: 6, target: 'Wing control and board basics', pricePrivate: 520, priceGroup: 440 },
  { name: 'Wing Rider', hours: 9, target: 'Full progression — ride independently', pricePrivate: 630, priceGroup: 540, highlight: true },
];

export const courseNotes = [
  'Group = max 3 students per instructor',
  'Sessions split at 3–4 hours per day',
  'All include: equipment, transport, water/snacks, 1–2 hidden gem spots',
];
